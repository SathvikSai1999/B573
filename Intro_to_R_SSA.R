...
print(paste("The 10th letter is:", letter_10)) # "c"
letter_758 <- my_fasta[[1]][758]   #1st sequence letter_758
print(paste("The 758th letter is:", letter_758)) # "a"
...
sequence_79 = my_fasta[[1]][79]
# Convert to DNAStringSet
dna_sequences <- DNAStringSet(sequence_79)
# Calculate reverse complement
rev_comp <- reverseComplement(dna_sequences)
rev_comp 
print(paste("The 79th letter of this sequence is", rev_comp)) #A

sequence_500_800 = my_fasta[[1]][500:800]
dna_sequences <- DNAStringSet(sequence_500_800)
rev_comp <- reverseComplement(dna_sequences)
rev_comp #301 elements in it
# Inclusive Indexing meaning both 500th and 800th elemts are included, hence, the 301 elements in it.
